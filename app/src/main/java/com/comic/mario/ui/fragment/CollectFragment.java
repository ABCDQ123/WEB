...
public class CollectFragment extends LazyFragment implements MutiViewHolder {
    ...
    public static CollectFragment newInstance(Serializable obj) {
    ...
    private void initData() {
        new Thread(() -> {
            try {
                ...
                if (preferencesManager.getCollect() != null) {
                    JSONArray jsonArray = new JSONArray(preferencesManager.getCollect());
        ...
        if (tag == 1) {
            ...
            holder.itemView.setOnClickListener(v -> {
                ...
                for (String webname : files) {
                    if (webname.replace("web_", "").equals(dataBean.getIntro())) {
